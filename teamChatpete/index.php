...
<head>
        ...
        <!-- <meta charset="utf-8" />
        <title>Chat | TalkItit - Chat App</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content=" Chat App" name="description" />
        <meta content="Project" name="TalkItit" /> -->
        <!-- App favicon -->
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-4 col-8">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-3 ms-0">
                                            <img src="profileUploads/<?php echo getpic('User_Img')?>" class="rounded-circle avatar-xs" alt="">
                                        </div>
                                        <div class="flex-grow-1 overflow-hidden">
                                            <h5 class="font-size-16 mb-0 text-truncate"><a href="#" class="text-reset user-profile-show"><?php echo getUser('user') ?></a> <i class="ri-record-circle-fill font-size-10 text-success d-inline-block ms-1"></i></h5>
                                        </div>
                                    </div>
                                </div>
...
<!--     
                        ...
                        <div class="chat-input-section p-3 p-lg-4 border-top mb-0">
                            <form action="" name="text_form" class="text_form" method="post">
                            <div class="row g-0">
                                <div class="col">
                                    <input type="text" name="input_Field" class="form-control form-control-lg bg-light border-light input_Field" placeholder="Enter Message...">
                                    <input type="text" class="outGoingId" name="outGoingId" value=" <?php echo User('id')?>" hidden>                                   
                                    <input type="text" class="incommingId" name="incommingId" value=" <?php echo $_SESSION['id']?>" hidden>
                                ...
                                <div class="col-auto">
                                    <div class="chat-input-links ms-md-2 me-md-0">
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li class="list-inline-item">
                                                <button type="submit" name="send" class="btn btn-primary btn_snd font-size-16 btn-lg chat-send waves-effect waves-light">
                    ...
                    <div class="user-profile-sidebar">
                        ...
                        <div class="text-center p-4 border-bottom">
                            <div class="mb-4">
                                <img src="profileUploads/<?php echo getPic('User_Img')?>" class="rounded-circle avatar-lg img-thumbnail" alt="">
                            </div>

                            <h5 class="font-size-16 mb-1 text-truncate"><?php echo getUser ('user')?></h5>
                                    ...
                                    <div id="aboutprofile" class="accordion-collapse collapse show" aria-labelledby="about3" data-bs-parent="#myprofile">
                                        <div class="accordion-body">
                                            <div>
                                                ...
                                                <h5 class="font-size-14"><?php echo getUser ('user')?></h5>
                                            </div>

                                            <div class="mt-4">
                                                <p class="text-muted mb-1">Email</p>
                                                <h5 class="font-size-14"><?php echo getUser ('email')?></h5>
                                            </div>
