                                    ...
                                    <form action="https://themesbrand.com/chatvia/layouts/index.html">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group bg-soft-light rounded-3  mb-3">
                                                ...
                                                <input type="email" class="form-control form-control-lg bg-soft-light border-light" placeholder="Enter Email" aria-label="Enter Email" aria-describedby="basic-addon5">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group bg-soft-light mb-3 rounded-3">
                                                ...
                                                <input type="text" class="form-control form-control-lg bg-soft-light border-light" placeholder="Enter Username" aria-label="Enter Username" aria-describedby="basic-addon6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group bg-soft-light mb-3 rounded-3">
                                                ...
                                                <input type="password" class="form-control form-control-lg bg-soft-light border-light" placeholder="Enter Password" aria-label="Enter Password" aria-describedby="basic-addon7">
